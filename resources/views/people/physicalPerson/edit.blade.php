    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-12 my-2">
                <h2 class="my-4 text-secondary text-center">{{$physicalPerson->name}}</h2>
            </div>
            <div class="col-sm-12 col-12 d-lg-flex justify-content-lg-center mx-auto">
                <form action="{{ route('physicalPerson.update', ['physicalPerson'=>$physicalPerson->id]) }}" method="post" autocomplete="off">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        <div class="col-12">
