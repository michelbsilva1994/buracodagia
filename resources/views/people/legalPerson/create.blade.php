...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            ...
            <div class="col-12">
                <form class="row" action="{{route('legalPerson.store')}}" method="post" class="mt-4" autocomplete="off">
                    @csrf
                    <div class="col-md-12">
                        ...
                        <input type="text" class="form-control @error('corporate_name') is-invalid @enderror" id="corporate_name"
                            placeholder="Ex: Empresa LTDA" name="corporate_name" value="{{ old('corporate_name') }}">
                    ...
                    <div class="col-md-6">
                        ...
                        placeholder="Ex: Empresa" name="fantasy_name" value="{{ old('fantasy_name') }}">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control @error('telephone') is-invalid @enderror" id="telephone"
                            placeholder="Ex: 987000000" name="telephone" value="{{ old('telephone') }}">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control @error('cnpj') is-invalid @enderror" id="cnpj"
                            placeholder="Ex: 99.999.999/9999-99" name="cnpj" value="{{ old('cnpj') }}">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control @error('cep') is-invalid @enderror" id="cep"
                            placeholder="Ex: 60000-000" name="cep" value="{{ old('cep') }}">
                    ...
                    <div class="mt-2">
                        ...
                        <a href="{{route('legalPerson.index')}}" class="btn btn-danger">Cancelar</a>
                    </div>
                </form>
            </div>
        </div>
