    ...
    <div class="card mb-3">
        ...
        <div class="card-body row
            ...
            <div class="col-sm-12 col-md-4 col-lg-4">
                ...
                <a href="" class="btn btn-light" id="btn-lowers"
                                data-id-monthly="{{ $monthly->id }}" data-bs-toggle="modal"
                                data-bs-target="#modal-lowers">Baixas</a>
            </div>
            <div class="col-sm-12 col-md-4 col-lg-4">
                @if ($monthly->id_monthly_status === 'F')
                    <div class="d-grid gap-2 my-3">
                        ...
                        <a href="{{ route('monthly.lowerMonthlyFeeIndex', ['id_monthly' => $monthly->id]) }}"
                            class="btn btn-light">Baixas</a>
                    </div>
                @elseif($monthly->id_monthly_status === 'P')
                    <div class="d-grid gap-2 my-3">
                        @if (Auth::user()->user_type_service_order === 'U')
                        ...
                        @if (Auth::user()->user_type_service_order === 'E')
                            ...
                            <a href="{{ route('monthly.lowerMonthlyFeeIndex', ['id_monthly' => $monthly->id]) }}"
                                class="btn btn-sm btn-light">Baixas</a>
                        @endif
                    </div>
                @elseif($monthly->id_monthly_status === 'C')
                    <div class="d-grid gap-2 my-3 text-white">
                        -
                    </div>
                @else
                    @if (Auth::user()->user_type_service_order === 'U')
