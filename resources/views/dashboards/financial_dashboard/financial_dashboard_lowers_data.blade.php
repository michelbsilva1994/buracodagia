<div class="pb-4">
    ...
    <div class="table-data">
        <div id="items-container">
            @include('dashboards.financial_dashboard.financial_dasboard_lowers_paginate.financial_dashboard_lowers_data')
        </div>

        <div id="pagination-container">
            @include('dashboards.financial_dashboard.financial_dasboard_lowers_paginate.financial_dashboard_lowers_paginate')
        </div>
    </div>
</div>
