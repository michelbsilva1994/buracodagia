                ...
                <form action="{{ route('typeContract.update', ['typeContract'=>$typeContract->id]) }}" method="post" class="mt-4 row" autocomplete="off">
                    ...
                    <div class="col-12">
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="status" value="A" @if ($typeContract->status == 'A') checked @endif>
                            <label class="form-check-label" for="status">Ativo</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="status" value="I" @if ($typeContract->status == 'I') checked @endif>
