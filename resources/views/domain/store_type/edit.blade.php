...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="mt-2">
            <div class="col-12">
                <h2 class="my-4 text-secondary text-center">Cadastrar Tipo Contrato</h2>
            </div>
            @if (session('error'))
            ...
            <div class="col-sm-12 d-md-flex justify-content-md-center col-md-12">
                <form action="{{ route('storeType.update', ['storeType'=>$storeType->id]) }}" method="post" class="col-sm-12 col-md-10 col-lg-6" autocomplete="off">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="d-grid gap-2 d-md-flex justify-content-md-end my-4">
                        ...
                        <a href="{{route('storeType.index')}}" class="btn btn-lg btn-danger">Cancelar</a>
                    </div>
                </form>
            </div>
        </div>
