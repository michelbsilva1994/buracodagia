...
@section('content')
    <div class="container">
        <div class="">
            <div class="mt-2">
            <div class="col-12">
                <h2 class="my-4 text-secondary text-center">Loja {{$store->id}}</h2>
            </div>
            @if (session('error'))
            ...
            <div class="col-sm-12 d-md-flex justify-content-md-center col-md-12">
                <form action="{{ route('store.update', ['store' => $store->id]) }}" method="post" class="col-sm-12 col-md-10 col-lg-6" autocomplete="off">
                    @csrf
                    @method('PUT')
