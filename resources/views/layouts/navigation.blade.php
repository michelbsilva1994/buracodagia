                                ...
                                <div class="offcanvas-body">
                                    <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li><a class="dropdown-item" href="{{ route('store.index') }}">Lojas</a>
                                            </li>
                                            <li><a class="dropdown-item"
                                        ...
                                        <ul class="dropdown-menu">
                                            <li><a class="dropdown-item"
                                                    href="{{ route('storeStatus.index') }}">Status da loja</a></li>
                                            <li><a class="dropdown-item" href="{{ route('storeType.index') }}">Tipo
                                                    de loja</a></li>
                                            <li><a class="dropdown-item"
                                                    href="{{ route('typeContract.index') }}">Tipo de contrato</a></li>
                                            <li><a class="dropdown-item" href="{{ route('typePayment.index') }}">Tipo
                                                    de pagamento</a></li>
                                            <li><a class="dropdown-item" href="{{ route('typeCharge.index') }}">Tipo
                                                    de cobrança</a></li>
                                            <li><a class="dropdown-item"
                                                    href="{{ route('typeCancellation.index') }}">Tipo de
                                                    cancelamento</a></li>
                                            <li><a class="dropdown-item"
                                                    href="{{ route('contractCancellationType.index') }}">Tipo de de
